...
dnf5 -y install hyprland hyprpaper hyprlock hypridle hyprpolkitagent chafa foot foot-terminfo dunst waybar nwg-bar nwg-look imv wev zsh-autosuggestions zsh-syntax-highlighting cascadia-code-nf-fonts cascadia-mono-nf-fonts fontawesome-fonts-all
