...
dnf5 -y install hyprland hyprpaper hyprlock hypridle hyprpolkitagent chafa foot foot-terminfo dunst waybar wl-clipboard nwg-bar nwg-look imv wev zsh zsh-autosuggestions zsh-syntax-highlighting cascadia-code-nf-fonts cascadia-mono-nf-fonts google-noto-sans-fonts google-noto-sans-mono-fonts google-noto-serif-fonts guestfs-tools rclone socat vulkan-tools borgbackup fontawesome-fonts-all
